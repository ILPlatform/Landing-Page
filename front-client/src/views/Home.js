...
function LandingPage() {
  ...
  React.useEffect(() => {
    const getData = async () => {
      console.log("Calling");
      const data = await callFunction("users_e_get_images")();
      console.log(data);
    };
    getData();
  }, []);
            ...
            <Row className="align-items-center">
              ...
              <Col className="mx-auto" lg="6">
                ...
                <a href="/camps/" rel={"nofollow"}>
                  <Button className="btn-round btn-large w-75 mt-2">{data[0]?.button2}</Button>
                </a>
              </Col>
            </Row>
          </Container>
          ...
          <Container>
            <Row className="align-items-center">
              ...
              <Col className="mx-auto" lg="9">
                ...
                <a href="/camps/" rel={"nofollow"}>
                  <Button className="btn-round btn-large w-50 mt-4">{data[2]?.button}</Button>
                </a>
              </Col>
            </Row>
          </Container>
          ...
          <Container>
            <Row className="align-items-center">
              ...
              <Col className="mx-auto text-center" lg={3}>
                ...
                />
                <a href="/camps/" rel={"nofollow"}>
                  <Button className="btn-round w-100">{data[7]?.button2}</Button>
                </a>
              </Col>
              <Col lg={2} />
            </Row>
