  ...
  const meta = {
    ...
    meta: {
      property: {
        ...
        "og:image": require("../assets/img/home/ILPlatform_Teacher.jpg")
          .default,
          ...
          <Container>
            <Row className="align-items-center">
              <ColImg
                size={6}
                srcWebp={
                  require("../assets/img/home/ILPlatform_Teacher.webp").default
                }
                src={
          ...
          <Container>
            <Row className="align-items-center">
              ...
              <ColImg
                size={5}
                srcWebp={
                  require("../assets/img/home/ILPlatform_Robot.webp").default
                }
