...
function ParascolairesRegister(props) {
          ...
          <Row className="align-items-center">
            <Col className="mr-auto" lg="6" md="6" sm="5" xs="12">
              ...
              >
                ...
                <Form>
                  {['name', 'email', 'phone', 'name_child', 'class'].map((idx, i) => (
                    <FormGroupInput
                      idx={idx}
                      data={data}
                      info={customerInfo}
            ...
            <Col className="ml-auto" lg="6" md="6" sm="7" xs="12">
              {
                <>
                  ...
                  <ul>
                    ...
                    <p>
                      <li className="my-2">
                        <b>{para?.when}</b> {`${para?.time[0]} ${data?.general?.days[data?.when[0]]} ${para?.time[1]} ${data?.when[1]}, ${para?.time[2]} ${data?.when[2]} ${para?.time[3]} ${data?.when[3]}`}
                      </li>
                    </p>
                    <p>
                      <li className="my-2">
...
export default ParascolairesRegister;
